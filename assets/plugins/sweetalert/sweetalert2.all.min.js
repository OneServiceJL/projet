...
!(function (t, e) {
  ...
  function N() {
    var t = g(x().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
        function (t, e) {
          return (
  ...
  var se = {
    ...
    pe = Object.freeze({
      ...
      bindClickHandler: function () {
        (oe[0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 'data-swal-template'] =
          this),
  ...
  var ve = function () {
    ...
    ye = function (t) {
      ...
      return (
        !we(t) &&
        !Ce(t) &&
        (e === n || !(ut(n) || 'INPUT' === e.tagName || (ut(E()) && E().contains(e))))
      );
    },
    we = function (t) {
    ...
    return new Promise(function (t) {
      ...
      ke.swalPromiseResolve.set(a, t),
        (c.confirmButton.onclick = function () {
          return (
            (e = s), (t = a).disableButtons(), void (e.input ? cn(t, e, 'confirm') : ln(t, e, !0))
          );
          var t, e;
        }),
