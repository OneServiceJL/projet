$(function () {
  ...
  new Chart(ctx1, {
    ...
    data: {
      ...
      datasets: [{ label: 'Sales', data: [24, 10, 32, 24, 26, 20], backgroundColor: '#664dc9' }],
    },
    options: {
  ...
  new Chart(ctx2, {
    ...
    data: {
      labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
      datasets: [{ label: 'Sales', data: [14, 12, 34, 25, 24, 20], backgroundColor: '#44c4fa' }],
    },
    options: {
      maintainAspectRatio: false,
      responsive: true,
  ...
  new Chart(ctx3, {
    ...
    data: {
      labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
      datasets: [{ label: 'Sales', data: [14, 12, 34, 25, 24, 20], backgroundColor: gradient }],
    },
    options: {
      maintainAspectRatio: false,
      responsive: true,
