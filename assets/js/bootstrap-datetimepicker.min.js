  ...
  var c = function (c, d) {
    var e,
      ...
      C = function () {
        var b = a('<thead>').append(
          ...
          c = a('<tbody>').append(
            a('<tr>').append(a('<td>').attr('colspan', d.calendarWeeks ? '8' : '7')),
          );
        return [
          a('<div>')
      ...
      M = function () {
        ...
        for (
          d.calendarWeeks === !0 && b.append(a('<th>').addClass('cw').text('#'));
      ...
      S = function () {
        for (var b = [], c = f.clone().startOf('y').startOf('d'); c.isSame(f, 'y'); )
          b.push(
            a('<span>').attr('data-action', 'selectMonth').addClass('month').text(c.format('MMM')),
          ),
            c.add(1, 'M');
      ...
      V = function () {
        ...
        for (
          g.eq(0).find('span').attr('title', d.tooltips.prevCentury),
            ...
            (h.isSame(b({ y: 1900 })) || (d.minDate && d.minDate.isAfter(h, 'y'))) &&
              g.eq(0).addClass('disabled'),
            g.eq(1).text(h.year() + '-' + i.year()),
            (h.isSame(b({ y: 2e3 })) || (d.maxDate && d.maxDate.isBefore(i, 'y'))) &&
      ...
      aa = function (a) {
        ...
        if (((a = a.clone().locale(d.locale)), x() && a.tz(d.timeZone), 1 !== d.stepping))
          for (
            a.minutes(Math.round(a.minutes() / d.stepping) * d.stepping).seconds(0);
    ...
    if (
      ...
      (l.locale = function (a) {
        ...
        return (
          (d.locale = a), e.locale(d.locale), f.locale(d.locale), i && pa(), o && (ba(), ga()), l
        );
      }),
      ...
      (l.toolbarPlacement = function (a) {
        ...
        if (u.indexOf(a) === -1)
          throw new TypeError(
            'toolbarPlacement() parameter must be one of (' + u.join(', ') + ') value',
          );
