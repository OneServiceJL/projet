        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="studio-bookings.php">Studio Bookings</a></li>
                        <li><a href="production-schedule.php">Production Schedule</a></li>
                        <li><a href="equipment-usage.php">Equipment Usage</a></li>
                        <li><a href="recording-sessions.php">Recording Sessions</a></li>
                        <li><a href="studio-reports.php">Studio Reports</a></li>
                    </ul>
                </li>
