...
<div class="col-xl-3 col-sm-6 col-12 d-flex mb-3">
	<div class="dropdown w-100">
		...
		<div class="dropdown-menu w-100" aria-labelledby="dashboardDropdown">
			<a href="#eventModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-calendar-alt me-1"></i> Event Order
			</a>
			<a href="#quoteModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-file-alt me-1"></i> Quote Generator
			</a>
			<a href="#invoiceModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-file-invoice me-1"></i> Invoice Generator
			</a>
			<a href="#transportModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-truck me-1"></i> Transport Fleet Record
			</a>
			<a href="#equipmentModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-microchip me-1"></i> Equipment Records
			</a>
			<a href="#financeModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-file-invoice me-1"></i> Finance Record Expence, Income
			</a>
			<a href="#personalModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-user me-1"></i> Personal Report
			</a>
			<a href="#recruitmentModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-people-carry me-1"></i> Recruitment
			</a>
			<a href="#employeeModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-user-tie me-1"></i> Employee Management
			</a>
			<a href="#leaveModal" class="dropdown-item" data-bs-toggle="modal">
				<i class="fas fa-hospital me-1"></i> Leave Management
			</a>
			<a href="#marketModal" class="dropdown-item" data-bs-toggle="modal">
